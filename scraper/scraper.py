...
def get_group_post_as_line(post_id, photos_dir):
    try:
        ...
        comment_photos_theater_links = utils.get_post_comment_photos_links(data, selectors)
        ...
        comment_photos = image_downloader(comment_photos_spotlight_links, photos_dir)
        line = (
            str(time)
            + "||"
            + str(post_type)
